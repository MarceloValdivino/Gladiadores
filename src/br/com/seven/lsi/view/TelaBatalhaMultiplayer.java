    ...
    private void iniciarEsperaPoderUmPlayer() {
        Task t = new Task() {
            ...
            protected Object call() throws Exception {
                try {
                    poderUmPlayer = true;
                    btnPoderUm.setDisable(poderUmPlayer);
